...
public class ModelAndViewController {
	...
	public void init() {
		...
		student2.setName("hanako suzuki");
		...
		student3.setName("hanako yamada");
	...
	public ModelAndView post(@RequestParam(value="name")String name, ModelAndView mav) {
		mav.setViewName("index");
		System.out.println("post to index invoked");
